...
window.addEventListener("load", function load(event) {
  ...
  var txt = document.createTextNode('We will be closing at 6PM on Wednesday, November 23rd for the Thanksgiving holiday. We\'ll open again on Saturday, November 26th at 8AM. Best wishes to you and yours for the holiday!');
  msg.appendChild(txt);
