      ...
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
            <span class="glyphicon glyphicon-heart" style="font-size:30px; color:#f5b900;"></span>
          </button>
          <a class="navbar-brand hidden-xs hidden-sm" href="/#home"><span class="glyphicon glyphicon-heart" style="font-size:18px; color:#f5b900;"></span></a>
        </div>
