      ...
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
            <span class="glyphicon glyphicon-heart" style="font-size:30px; color:#F9E08C;"></span>
          </button>
          <a class="navbar-brand hidden-xs hidden-sm" href="/#home"><span class="glyphicon glyphicon-heart" style="font-size:18px; color:#F9E08C;"></span></a>
        </div>
...
HTML::macro('nav_index_auth', function()
{
    ...
    '
			...
			<!-- <li> <a href="#thanksgiving-menu" class="smoothScroll">Thanksgiving 2016</a></li> -->
		...
		<footer class="site-footer">
			<div id="footerwrap">
					<div class="container">
							...
							<a href="http://kdeb-csci-e15.me">Credits</a>&nbsp;&nbsp;&nbsp;&nbsp;
